...
class TestSuiteController @Inject()(
  ...
  def getTestSuites: Action[AnyContent] = authorizedAction.requirePermission(Permissions.TESTSUITES_READ).async { implicit request =>
  ...
  def getTestSuite(id: String): Action[AnyContent] = authorizedAction.requirePermission(Permissions.TESTSUITES_READ).async { implicit request =>
  ...
  def createTestSuite(): Action[AnyContent] = authorizedAction.requirePermission(Permissions.TESTSUITES_CREATE).async { implicit request =>
  ...
  def updateTestSuite(): Action[AnyContent] = authorizedAction.requirePermission(Permissions.TESTSUITES_UPDATE).async { implicit request =>
