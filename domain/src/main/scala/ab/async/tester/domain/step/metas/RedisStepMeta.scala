...
case class RedisStepMeta(
  ...
  override def stepType: ab.async.tester.domain.enums.StepType =
    ab.async.tester.domain.enums.StepType.RedisOperation
}
...
object RedisOperation {
  ...
  implicit val redisOperationEncoder: Encoder[RedisOperation] =
  ...
  implicit val redisOperationDecoder: Decoder[RedisOperation] =
